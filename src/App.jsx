...
export const router = createBrowserRouter([
  ...
  { path: "/student/notifications", element: <SimpleWorkQueuePage title="Notifications" description="Academic notices and messages" items={[
    { title: "Midterm Examination Schedule", meta: "Office of Academic Affairs • March 15, 2026", status: "Unread" },
    { title: "Enrollment for Summer Classes Now Open", meta: "Registrar Office • March 10, 2026", status: "New" },
    { title: "Library Operating Hours Update", meta: "Library Services • March 8, 2026", status: "Read" },
  ]} /> },
  { path: "/student/profile", element: <SimpleWorkQueuePage title="Student Profile" description="Personal information, program details, and account status" items={[
  ...
  { path: "/teacher/notifications", element: <SimpleWorkQueuePage title="Faculty Notifications" description="Faculty announcements and teaching reminders" items={[
    { title: "Faculty Meeting - March 20", meta: "Dean's Office • Conference Room A", status: "Unread" },
    { title: "Grade Submission Deadline Reminder", meta: "Registrar Office • Due March 28, 2026", status: "Due Soon" },
    { title: "New LMS Features Available", meta: "IT Services • March 10, 2026", status: "Read" },
  ]} /> },
  { path: "/teacher/profile", element: <SimpleWorkQueuePage title="Faculty Profile" description="Teaching profile, load assignment, and department details" items={[
  ...
  { path: "/admin/settings", element: <SimpleWorkQueuePage title="System Settings" description="Portal configuration, access control, and academic term setup" items={[
  ...
  { path: "/registrar/records", element: <SimpleWorkQueuePage title="Student Records" description="Transcript, certificates, and academic document requests" items={recordsItems} /> },
  ...
  { path: "/finance/payments", element: <SimpleWorkQueuePage title="Payment Ledger" description="Cashier, bank transfer, and online payment review" items={financeItems} /> },
  { path: "/finance/balances", element: <TuitionPage /> },
  { path: "/finance/statements", element: <SimpleWorkQueuePage title="Statements" description="Student billing statements and account notices" items={financeItems} /> },
  { path: "/finance/collections", element: <SimpleWorkQueuePage title="Collections" description="Outstanding accounts, reminders, and cashier follow-ups" items={financeItems} /> },
